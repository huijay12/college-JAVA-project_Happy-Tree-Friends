...
public class HappyTreeGame_8 extends Frame implements MouseMotionListener, MouseListener, ActionListener
{
   

   //背景
public static void playSound0()
{
     try
 {
...
public static void playSound()
{
     try
 {
	AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("v2.wav").getAbsoluteFile());
	Clip clip = AudioSystem.getClip();
	clip.open(audioInputStream);
	if(now>0)
	clip.start();
   ...
   public static void playSound2()
{
	try
	{
	AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("scream1.wav").getAbsoluteFile());
	Clip clip = AudioSystem.getClip();
	clip.open(audioInputStream);
	clip.start();
//	System.out.println("sound.");
   ...
   public static void playSound3()
{
	try
	{
	AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("Hahaha.wav").getAbsoluteFile());
	Clip clip = AudioSystem.getClip();
	clip.open(audioInputStream);
	clip.start();
//	System.out.println("sound.");
	...
	catch(Exception ex)
{
   ...
   static HappyTreeGame_8 frm = new HappyTreeGame_8();                                   //視窗
