...
public class HappyTreeGame_7 extends Frame implements MouseMotionListener, MouseListener, ActionListener
{
	...
	catch(Exception ex)
{
   ...
   static HappyTreeGame_7 frm = new HappyTreeGame_7();                                   //視窗
